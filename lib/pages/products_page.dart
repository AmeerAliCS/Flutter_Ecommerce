      ...
      child: StoreConnector<AppState, AppState>(
        ...
        builder: (context, state) {
          return AppBar(
            ...
            title: SizedBox(
                child:
                    state.user != null ? Text(state.user.username) : FlatButton(
                      child: Text('Register', style: Theme.of(context).textTheme.bodyText1,),
                      onPressed: () => Navigator.pushNamed(context, '/register'),
                    )),
            leading: state.user != null ? IconButton(icon: Icon(Icons.store) ,
              onPressed: () => Navigator.pushNamed(context, '/cart'),) : Text(''),
            actions: [
              Padding(
