...
class _RegisterPageState extends State<RegisterPage> {
    ...
    return Padding(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          hintText: 'Username',
          labelText: 'Enter username, min length 6',
  ...
  void _registerUser() async {
    ...
    http.Response response = await http.post('http://10.0.0.5:1337/auth/local/register',
    body: {
      'username' : _username,
      'email' : _email,
      'password' : _password
  ...
  void _showSuccessSnack(){
    final snackbar = SnackBar(
      content: Text(
          'User $_username successfully created!', style: TextStyle(color: Colors.green),
      ),
